...
import com.base.ifocus.myapplication.Adapter.EventListAdapter;
 ...
 */
public class EventFragment extends Fragment implements Response.Listener, Response.ErrorListener {
    ...
    public void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        errorListener = this;
        responseString = this;
        menuConn = new HttpConn(Helper.getCompleteUrl(getString(R.string.allEvents), getActivity()), getActivity());
        menuConn.getAsyncJsonArrayData(getString(R.string.allcat), responseString, errorListener);
    }

    @Override
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        view = (ViewGroup) inflater.inflate(R.layout.event_frag, null);
    ...
    private void createAdapter(Object response) {
        try {
            ...
            mRecentAdapter = new EventListAdapter(Helper.parseEventsArray(response),getActivity());
